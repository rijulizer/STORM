...
def main(
    ...
    # copy config file
    os.makedirs(f"ckpt/{run_params.exp_name}", exist_ok=True)
    shutil.copy(run_params.config_path, f"ckpt/{run_params.exp_name}/config.yaml")
    ...
    if run_params.conf.JointTrainAgent.UseDemonstration:
        ...
        ##Initialize wandb
    with wandb.init(
        project="Thesis",  # "Thesis",  # Replace with your project name
